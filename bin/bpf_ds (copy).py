...
int send_to(struct pt_regs *ctx) {
    struct data_t data = {};
...
#b.attach_kprobe(event="sys_recvfrom", fn_name="recv_from")
#b.attach_kprobe( event="sys_sendto", fn_name="send_to")
b.attach_kprobe(event="sock_recvmsg", fn_name="sock_recv")
b.attach_kprobe( event="sock_sendmsg", fn_name="sock_send")
...
b["events"].open_perf_buffer(print_event, page_cnt=64*8)
while 1:
    b.perf_buffer_poll()
